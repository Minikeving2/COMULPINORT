	  ...
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
				...
				<div class="card card-body">
					...
					<div class="form-group">
						<div class="col-sm-2">
							...
							<input type="text" class="form-control" id="mod_nit" name="nit" >
						</div>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="mod_nombre_cliente" name="nombre_cliente" >
						</div>
						<div class="col-sm-2">
							<input type="text" class="form-control" id="mod_codigo_sicom" name="codigo_sicom" >
						</div>
						<div class="col-sm-2">
					...
					<div class="form-group">	
						...
						<div class="col-sm-2">
							<input type="text" class="form-control" id="mod_cupo" name="cupo" >
						</div>
						<div class="col-sm-3">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control input-sm" id="mod_date_added" value="" readonly>
						</div>
						<div class="col-sm-2">
					...
					<div class="form-group">
						<div class="col-sm-3">
							<input type="text" class="form-control" id="mod_telefono_cliente" name="telefono_cliente" > 
						</div>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="mod_email_cliente" name="email_cliente" >
						</div>
						<div class="col-md-5">
			...
			<button id="section" type="button" data-toggle="collapse" data-target="#datosrp" aria-expanded="false" aria-controls="collapseExample">
				<div class="panel-body p-3 mb-2 bg-primary text-white">
						<span class="d-block  text-white"> Datos del Representante legal</span>
				</div>
			</button> 

			<div class="collapse" id="datosrp">
			<div class="card card-body"> 
			...
			<div class="form-group">
			  	<div class="col-sm-6">
					<input type="text" class="form-control" id="mod_email_rp" name="email_rp" >
				</div>
				<div class="col-md-6">
