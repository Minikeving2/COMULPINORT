		  ...
		  <div class="modal-body">
			...
			<div class="panel panel-default">
			  ...
			  <div class="form-group">			
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="codigo_sicom" name="codigo_sicom" > </div>
				<div class="col-sm-2">
			  ...
			  <div class="form-group">	
			    ...
			    <div class="col-sm-2">
					<input type="text" class="form-control" id="cupo" name="cupo" > </div>
			    <div class="col-sm-3">
			  ...
			  <div class="form-group">
			    <div class="col-sm-3">
					<input type="text" class="form-control" id="telefono_cliente" name="telefono_cliente" > </div>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="email_cliente" name="email_cliente" > </div>
				<div class="col-md-5">
				      <textarea class="form-control" id="direccion_cliente" name="direccion_cliente"   maxlength="100" ></textarea>	    
				    </div>
				</div>  
			  ...
			  <div class="form-group">
		    	<div class="col-sm-2">
					<input type="text" class="form-control" id="cc_rp" name="cc_rp" > </div>
				<div class="col-sm-7">
					<input type="text" class="form-control" id="nombre_rp" name="nombre_rp" ></div>    
				<div class="col-sm-3">
					<input type="text" class="form-control" id="tel_rp" name="tel_rp" > </div>
			  </div>
			  ...
			  <div class="col-sm-6">
					<input type="text" class="form-control" id="email_rp" name="email_rp" > </div>
				<div class="col-md-6">
				      <textarea class="form-control" id="direccion_rp" name="direccion_rp"   maxlength="100" ></textarea>	    
				    </div>
		      </div>
